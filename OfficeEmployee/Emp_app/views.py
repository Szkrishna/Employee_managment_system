...
def add_emp(request):
    if request.method == 'POST':
        ...
        new_emp = Employee(first_name=first_name, last_name=last_name, salary=salary, bonus=bonus, phone=phone, dep_id=department, role_id=role, hire_date=datetime.now())
        new_emp.save()
